...
describe('favoriteBlog', () => {
  ...
  test('returns nothing when list is empty', () => {
    const emptyBlogList = []
  ...
  test('returns right favorite blog', () => {
    const listWithManyBlogs = [
      {
        _id: "5a422a851b54a676234d17f7",
        title: "React patterns",
...
describe('mostBlogs', () => {
  ...
  test('when list has one blog returns author of that', () => {
    const listWithOneBlog = [
      {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Go To Statement Considered Harmful',
...
describe('mostLikes', () => {
  ...
  test('when list has one blog returns author and likes of that', () => {
    const listWithOneBlog = [
      {
        _id: '5a422aa71b54a676234d17f8',
        title: 'Go To Statement Considered Harmful',
